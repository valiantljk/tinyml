...
#define AI_NETWORK_MODEL_SIGNATURE     "3482e72bd7d904277776976aa3bbebde"
...
#define AI_TOOLS_DATE_TIME   "Wed Aug 31 22:23:55 2022"
...
/* Array#11 */
AI_ARRAY_OBJ_DECLARE(
  node_56_to_chlast_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 740, AI_STATIC)
/* Array#12 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#35 */
AI_ARRAY_OBJ_DECLARE(
  node_57_weights_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  node_56_to_chlast_output, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 37, 20), AI_STRIDE_INIT(4, 4, 4, 4, 148),
  1, &node_56_to_chlast_output_array, NULL)

/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  node_56_to_chlast_output0, AI_STATIC,
  12, 0x0,
...
/* Tensor #36 */
AI_TENSOR_OBJ_DECLARE(
  node_57_weights, AI_STATIC,
  36, 0x0,
  AI_SHAPE_INIT(4, 740, 10, 1, 1), AI_STRIDE_INIT(4, 4, 2960, 29600, 29600),
  1, &node_57_weights_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &node_59_weights, &node_59_bias),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &node_56_to_chlast_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &node_57_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &node_57_weights, &node_57_bias),
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  node_56_to_chlast_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &node_54_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &node_56_to_chlast_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  node_56_to_chlast_layer, 16,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &node_56_to_chlast_chain,
...
AI_LAYER_OBJ_DECLARE(
  ...
  bn, forward_bn,
  &node_54_chain,
  NULL, &node_56_to_chlast_layer, AI_STATIC, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    41196, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 7804, 1, 1),
    7804, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(g_network_activations_map[0] + 2804);
    input_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2804);
    
    node_40_output_array.data = AI_PTR(g_network_activations_map[0] + 288);
    node_40_output_array.data_start = AI_PTR(g_network_activations_map[0] + 288);
    
    node_42_output_array.data = AI_PTR(g_network_activations_map[0] + 288);
    node_42_output_array.data_start = AI_PTR(g_network_activations_map[0] + 288);
    
    node_43_output_array.data = AI_PTR(g_network_activations_map[0] + 260);
    node_43_output_array.data_start = AI_PTR(g_network_activations_map[0] + 260);
    
    node_45_output_array.data = AI_PTR(g_network_activations_map[0] + 260);
    node_45_output_array.data_start = AI_PTR(g_network_activations_map[0] + 260);
    
    node_46_output_array.data = AI_PTR(g_network_activations_map[0] + 200);
    node_46_output_array.data_start = AI_PTR(g_network_activations_map[0] + 200);
    
    node_48_output_array.data = AI_PTR(g_network_activations_map[0] + 200);
    node_48_output_array.data_start = AI_PTR(g_network_activations_map[0] + 200);
    
    node_49_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    node_49_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    
    node_51_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    node_51_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    ...
    node_54_output_array.data = AI_PTR(g_network_activations_map[0] + 2960);
    node_54_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2960);
    
    node_56_to_chlast_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    node_56_to_chlast_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    node_57_output_array.data = AI_PTR(g_network_activations_map[0] + 2960);
    node_57_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2960);
    
    node_58_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    node_58_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    node_59_output_array.data = AI_PTR(g_network_activations_map[0] + 40);
    node_59_output_array.data_start = AI_PTR(g_network_activations_map[0] + 40);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    node_40_weights_array.data = AI_PTR(g_network_weights_map[0] + 0);
    node_40_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    node_40_bias_array.format |= AI_FMT_FLAG_CONST;
    node_40_bias_array.data = AI_PTR(g_network_weights_map[0] + 72);
    node_40_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 72);
    
    node_42_scale_array.format |= AI_FMT_FLAG_CONST;
    node_42_scale_array.data = AI_PTR(g_network_weights_map[0] + 84);
    node_42_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 84);
    
    node_42_bias_array.format |= AI_FMT_FLAG_CONST;
    node_42_bias_array.data = AI_PTR(g_network_weights_map[0] + 96);
    node_42_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 96);
    
    node_43_weights_array.format |= AI_FMT_FLAG_CONST;
    node_43_weights_array.data = AI_PTR(g_network_weights_map[0] + 108);
    node_43_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 108);
    
    node_43_bias_array.format |= AI_FMT_FLAG_CONST;
    node_43_bias_array.data = AI_PTR(g_network_weights_map[0] + 408);
    node_43_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 408);
    
    node_45_scale_array.format |= AI_FMT_FLAG_CONST;
    node_45_scale_array.data = AI_PTR(g_network_weights_map[0] + 428);
    node_45_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 428);
    
    node_45_bias_array.format |= AI_FMT_FLAG_CONST;
    node_45_bias_array.data = AI_PTR(g_network_weights_map[0] + 448);
    node_45_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 448);
    
    node_46_weights_array.format |= AI_FMT_FLAG_CONST;
    node_46_weights_array.data = AI_PTR(g_network_weights_map[0] + 468);
    node_46_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 468);
    
    node_46_bias_array.format |= AI_FMT_FLAG_CONST;
    node_46_bias_array.data = AI_PTR(g_network_weights_map[0] + 1268);
    node_46_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1268);
    
    node_48_scale_array.format |= AI_FMT_FLAG_CONST;
    node_48_scale_array.data = AI_PTR(g_network_weights_map[0] + 1308);
    node_48_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 1308);
    
    node_48_bias_array.format |= AI_FMT_FLAG_CONST;
    node_48_bias_array.data = AI_PTR(g_network_weights_map[0] + 1348);
    node_48_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1348);
    
    node_49_weights_array.format |= AI_FMT_FLAG_CONST;
    node_49_weights_array.data = AI_PTR(g_network_weights_map[0] + 1388);
    node_49_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1388);
    
    node_49_bias_array.format |= AI_FMT_FLAG_CONST;
    node_49_bias_array.data = AI_PTR(g_network_weights_map[0] + 4588);
    node_49_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4588);
    
    node_51_scale_array.format |= AI_FMT_FLAG_CONST;
    node_51_scale_array.data = AI_PTR(g_network_weights_map[0] + 4668);
    node_51_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 4668);
    
    node_51_bias_array.format |= AI_FMT_FLAG_CONST;
    node_51_bias_array.data = AI_PTR(g_network_weights_map[0] + 4748);
    node_51_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4748);
    
    node_52_weights_array.format |= AI_FMT_FLAG_CONST;
    node_52_weights_array.data = AI_PTR(g_network_weights_map[0] + 4828);
    node_52_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4828);
    
    node_52_bias_array.format |= AI_FMT_FLAG_CONST;
    node_52_bias_array.data = AI_PTR(g_network_weights_map[0] + 11228);
    node_52_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11228);
    
    node_54_scale_array.format |= AI_FMT_FLAG_CONST;
    node_54_scale_array.data = AI_PTR(g_network_weights_map[0] + 11308);
    node_54_scale_array.data_start = AI_PTR(g_network_weights_map[0] + 11308);
    
    node_54_bias_array.format |= AI_FMT_FLAG_CONST;
    node_54_bias_array.data = AI_PTR(g_network_weights_map[0] + 11388);
    node_54_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11388);
    
    node_57_weights_array.format |= AI_FMT_FLAG_CONST;
    node_57_weights_array.data = AI_PTR(g_network_weights_map[0] + 11468);
    node_57_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 11468);
    
    node_57_bias_array.format |= AI_FMT_FLAG_CONST;
    node_57_bias_array.data = AI_PTR(g_network_weights_map[0] + 41068);
    node_57_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 41068);
    
    node_59_weights_array.format |= AI_FMT_FLAG_CONST;
    node_59_weights_array.data = AI_PTR(g_network_weights_map[0] + 41108);
    node_59_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 41108);
    
    node_59_bias_array.format |= AI_FMT_FLAG_CONST;
    node_59_bias_array.data = AI_PTR(g_network_weights_map[0] + 41188);
    node_59_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 41188);
